...
function appendWelcomeMessage() {
    appendMessage('🤖', `
        ...
        <div class="flex gap-2 flex-wrap mt-4">
            <button onclick="fillAndSend('Show me the top 5 highest rated action movies')" class="text-xs bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 px-3 py-1.5 rounded-full hover:bg-gray-100 dark:hover:bg-white/10 transition-colors shadow-sm">Top 5 Action</button>
